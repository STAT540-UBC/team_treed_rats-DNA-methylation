...
epi_genes <- dmr_set %>%
  ...
  setnames(c("gene", "epi_regulated", "non_epi_regulated")) %>%
...
write.table(dmr_set %>% filter(gene %in% epi_gene_list), file = "2_genes_DMR_associations.tsv", row.names = F, quote = F, sep = "\t")
```
